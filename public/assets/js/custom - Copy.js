...
$(document).ready(function () {
     ...
     $("#addAnotherEdicationalProgram").click(function () {
          var intId = $(".EducationalProgram .row.mt-3").length + 1 || 1;
          var addFields =
     ...
     $("#AddAnotherAnaphylacticAllergy").click(function () {
          var intId = $(".m_addAnaphylacticAllergy_form .row.m-1").length + 1 || 1;
          var addFields =
               $(`<div class="row m-1 white-background" id="anahylacticAllergy_child_form_` + intId + `">
                    <div class="col-md-12 mt-3">
                         <div class="educationalHeader">
                              <p><strong class="anaphylactic_allergy_title">Anaphylactic allergy `+ intId + `</strong></p>
                    ...
                    <div class="col-md-12 mt-3">
                         <div class="form-group">
                              ...
                              <select class="form-control" name="m_allergic_to[`+ intId + `]">
                    ...
                    <div class="col-md-12 mt-3 m_hospital_name_`+ intId + `" >
                         <div class="form-group">
                              ...
                              <div class="form-control-wrap">
                                   <input type="text" class="form-control" name="m_hospital_name[`+ intId + `]">
                              </div>
                         </div>
                    </div>
                    <div class="col-md-12 mt-3">
                    ...
                    <div class="col-md-12 mt-3 m_docter_treating_allergy_`+ intId + `">
                         <div class="form-group">
                              ...
                              <div class="form-control-wrap">
                                   <select class="form-control" name="m_docter_treating_allergy[`+ intId + `]"  onclick="change_docter_treating_allergy(this.value)">
                                        <option value="">select</option>
                                   </select>
                              </div>
                         </div>
                    ...
                    <div class="col-md-12 mt-3 m_adrenaline_autoinjector_`+ intId + `" >
                         <div class="form-group">
                              ...
                              <div class="form-control-wrap">
                                   <input type="text" class="form-control date-picker-alt" name="m_adrenaline_autoinjector[`+ intId + `]">
                              </div>
                         </div>
                    </div>
                    <div class="col-md-12 mt-3">
                         ...
                         <div class="row">
                              ...
                              <div class="col-md-12 mt-3">
                                   <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                             <input type="text" class="form-control" name="m_medication_name[`+ intId + `][0]">
                                        </div>
                                   </div>
                              </div>
                         </div>
     ...
     $("#AddAnotherMedicalCondition").click(function () {
          var intId = $(".m_addMedicalCondition_form .row.m-1").length + 1 || 1;
          var addFields =
               $(`<div class="row m-1 white-background" id="medical_condition_child_form_${intId}">
                    <div class="col-md-12 mt-3">
                         <div class="educationalHeader">
                              <p><strong class="medical_condition_title">Medical condition ${intId}</strong></p>
                    ...
                    <div class="col-md-12 mt-3">
                         <div class="form-group">
                              ...
                              <select class="form-control" name="m_medical_condition_name[${intId}]">
                                   <option value="">Select</option>
                    ...
                    <div class="col-md-12 mt-3 m_medical_condition_hospital_name_${intId}" >
                         <div class="form-group">
                              <label class="form-label">Hospital name</label>
                              <div class="form-control-wrap">
                                   <input type="text" class="form-control" name="m_medical_condition_hospital_name[${intId}]">
                              </div>
                         </div>
                    </div>
                    <div class="col-md-12 mt-3">
                    ...
                    <div class="col-md-12 mt-3 m_treating_medical_condition_${intId}">
                         <div class="form-group">
                              ...
                              <div class="form-control-wrap">
                                   <select class="form-control" name="m_treating_medical_condition[${intId}]" onclick="change_treating_medical_condition(this.value)">
                                        <option value="">select</option>
                                   </select>
                              </div>
                         </div>
                         ...
                         <div class="row">
                              ...
                              <div class="col-md-12 mt-3">
                                   <div class="form-group">
                                        <label class="form-label"><span class="required">*</span>Name</label>
                                        <div class="form-control-wrap">
                                             <input type="text" class="form-control" name="m_taking_medical_condition_name[${intId}][0]">
                                        </div>
                                   </div>
                              </div>
                         </div>
     ...
     $("#AddAnotherNonSevereAllergy").click(function () {
          var intId = $(".m_addNonSevereAllergy_form .row.m-1").length + 1 || 1;
          var addFields =
               $(`<div class="row m-1 white-background" id="non_severe_Allergy_child_form_${intId}">
                    <div class="col-md-12 mt-3">
                         <div class="educationalHeader">
                              <p><strong class="non_severe_allergy_title">Non-severe allergy ${intId}</strong></p>
                    ...
                    <div class="col-md-12 mt-3">
                         <div class="form-group">
                              <label class="form-label">The student is allergic to...</label>
                              <select class="form-control" name="m_non_severe_allergic_to[${intId}]">
                                   <option value="">Select</option>
                                   <option value="ALC">Cow's milk</option>
                                   <option value="ALE">Egg</option>
                                   <option value="ALF">Fish</option>
                    ...
                    <div class="col-md-12 mt-3 m_non_severe_docter_treating_allergy_${intId}">
                         <div class="form-group">
                              <label class="form-label">Please select the doctor that is treating this allergy</label>
                              <div class="form-control-wrap">
                                   <select class="form-control" name="m_non_severe_docter_treating_allergy[${intId}]"  onclick="change_non_severe_docter_treating_allergy(this.value)">
                                        <option value="">select</option>
                                   </select>
                              </div>
                         </div>
                    ...
                    <div class="col-md-12 mt-3 m_non_severe_adrenaline_autoinjector_${intId}" >
                         <div class="form-group">
                              <label class="form-label"><span class="required">*</span>Expiry date of adrenaline autoinjector</label>
                              <div class="form-control-wrap">
                                   <input type="text" class="form-control date-picker-alt" name="m_non_severe_adrenaline_autoinjector[${intId}]">
                              </div>
                         </div>
                    </div>
                    <div class="col-md-12 mt-3">
                         ...
                         <div class="row">
                              ...
                              <div class="col-md-12 mt-3">
                                   <div class="form-group">
                                        <label class="form-label"><span class="required">*</span>Name</label>
                                        <div class="form-control-wrap">
                                             <input type="text" class="form-control" name="m_non_severe_medication_name[${intId}][0]">
                                        </div>
                                   </div>
                              </div>
                         </div>
...
function addAnotherDocter(id) {
     var intId = $(".p_contact_number_form_" + id + " .row.mt-3").length + 1 || 1;
     var addFields =
...
function addAnotherMedication(index) {
     var intId = $("#m_addMedicationAllergy_parent_form_" + index + " .row").length + 1 || 1;
     var addFields =
          $(`<div class="row" id="m_addMedicationAllergy_child_form_` + index + `_` + intId + `">
               <div class="col-md-12 mt-3">
                    <div class="educationalHeader">
                         <p><strong class="medication_name_title">Medication `+ intId + `</strong></p>
               ...
               <div class="col-md-12 mt-3">
                    <div class="form-group">
                         <label class="form-label"><span class="required">*</span>Name</label>
                         <div class="form-control-wrap">
                              <input type="text" class="form-control" name="m_medication_name[`+ index + `][` + intId + `]">
                         </div>
                    </div>
               </div>
          </div>`);
...
function addAnotherDocterMedicalCentre() {
     var intId = $(".m_addAnotherDocterMedicalCentre_form .row.mt-3").length + 1 || 1;
     var addFields =
          $(`<div class="row mt-3" id="m_addAnotherDocterMedicalCentre_form_${intId}">
               <div class="col-md-12 mt-3">
                    <div class="educationalHeader">
                         <p><strong  class="student_doctor_title">Doctor ${intId}</strong></p>
               ...
               <div class="col-md-6 mt-3">
                    <div class="form-group">
                         ...
                         <div class="form-control-wrap">
                              <input type="text" class="form-control" name="m_docter_name[${intId}]" onchange="changeDoctorName(this)">
                         </div>
                         <p class="description">The name of a medical centre is also accepted.</p>
                    </div>
               </div>
               <div class="col-md-6 mt-3">
                    <div class="form-group">
                         ...
                         <select class="form-control" name="m_docter_country[${intId}]" id="m_docter_country_${intId}"  onchange="change_doctor_country(${intId}, this.value)">
               ...
               <div class="col-md-6 mt-3 doctor_australia_country_${intId}">
                    <div class="form-group">
                         ...
                         <div class="form-control-wrap">
                              <input type="text" class="form-control" name="m_street[${intId}]">
                         </div>
               ...
               <div class="col-md-6 mt-3 doctor_australia_country_${intId}">
                    <div class="form-group">
                         ...
                         <div class="form-control-wrap">
                              <input type="text" class="form-control" name="m_suburb[${intId}]">
                         </div>
               ...
               <div class="col-md-3 mt-3 doctor_australia_country_${intId}">
                    <div class="form-group">
                         ...
                         <div class="form-control-wrap">
                              <select class="form-control" name="m_state[${intId}]">
                                   <option value="none">select...</option>
               ...
               <div class="col-md-3 mt-3 doctor_australia_country_${intId}">
                    <div class="form-group">
                         ...
                         <div class="form-control-wrap">
                              <input type="text" class="form-control" name="m_postcode[${intId}]">
                         </div>
                    </div>
               </div>
               <div class="col-md-12 mt-3 doctor_other_country_${intId}">
                    <div class="form-group">
                         ...
                         <div class="form-control-wrap">
                              <input type="text" class="form-control" name="m_address_line_1[${intId}]" placeholder="Address line 1">
                         </div>
                    </div>
               </div>
               <div class="col-md-12 mt-3 doctor_other_country_${intId}">
                    <div class="form-group">
                         <div class="form-control-wrap">
                              <input type="text" class="form-control" name="m_address_line_2[${intId}]" placeholder="Address line 2">
                         </div>
                    </div>
               </div>
               <div class="col-md-6 mt-3">
                    <div class="form-group">
                         <label class="form-label">Phone number</label>
                         <div class="form-control-wrap">
                              <input type="text" class="form-control" name="m_phone_number[${intId}]">
                         </div>
                         <p class="description">In special circumstances the school may ask permission to contact the student's doctor.</p>
                    </div>
               </div>
...
function addNonSevereAnotherMedication(index) {
     var intId = $(`#m_addNonSevereMedicationAllergy_parent_form_${index} .row`).length + 1 || 1;
     var addFields =
          $(`<div class="row" id="m_addNonSevereMedicationAllergy_child_form_${index}_${intId}">
               <div class="col-md-12 mt-3">
                    <div class="educationalHeader">
                         <p><strong class="non_severe_medication_name_title">Medication ${intId}</strong></p>
               ...
               <div class="col-md-12 mt-3">
                    <div class="form-group">
                         <label class="form-label"><span class="required">*</span>Name</label>
                         <div class="form-control-wrap">
                              <input type="text" class="form-control" name="m_non_severe_medication_name[${index}][${intId}]">
                         </div>
                    </div>
               </div>
          </div>`);
...
function AddAnotherMedicalCondition(index) {
     var intId = $(`#m_addMedicalCondition_parent_form_${index} .row`).length + 1 || 1;
     var addFields =
          $(`<div class="row" id="m_addMedicalCondition_child_form_${index}_${intId}">
               <div class="col-md-12 mt-3">
                    <div class="educationalHeader">
                         <p><strong class="medical_condition_name_title">Medication ${intId}</strong></p>
               ...
               <div class="col-md-12 mt-3">
                    <div class="form-group">
                         <label class="form-label"><span class="required">*</span>Name</label>
                         <div class="form-control-wrap">
                              <input type="text" class="form-control" name="m_medical_condition_name[${index}][${intId}]">
                         </div>
                    </div>
               </div>
          </div>`);
...
function addAnotherTakingMedicalCondition(index) {
     var intId = $(`#m_addTakingMedicalCondition_parent_form_${index} .row`).length + 1 || 1;
     var addFields =
          $(`<div class="row" id="m_addTakingMedicalCondition_child_form_${index}_${intId}">
               <div class="col-md-12 mt-3">
                    <div class="educationalHeader">
                         <p><strong class="taking_medical_condition_name_title">Medication ${intId}</strong></p>
               ...
               <div class="col-md-12 mt-3">
                    <div class="form-group">
                         <label class="form-label"><span class="required">*</span>Name</label>
                         <div class="form-control-wrap">
                              <input type="text" class="form-control" name="m_taking_medical_condition_name[${index}][${intId}]">
                         </div>
                    </div>
               </div>
          </div>`);
...
function add_additional_parent(value) {
     if (value == 1) {
          var intId = $(`.accordion-item .accordion-body.collapse`).length + 1 || 1;
          var addFields =
...
function AddEmergencyAnotherContactNumber(index) {
     var intId = $(`.emergency_another_contact_number_${index} .row.mt-3`).length + 1 || 1;
     var addFields =
          $(`<div class="row mt-3" id="emergency_another_contact_number_child_${index}_${intId}">
               <div class="col-md-12">
                    <div class="educationalHeader">
                         <p><strong class="contact_number_title">Enter contact number ${intId}</strong></p>
               ...
               <div class="col-md-4 mt-3">
                    <div class="form-group">
                         ...
                         <div class="form-control-wrap">
                              <select class="form-control" name="e_emergency_phone_number_type[${index}][]">  
                                   <option value="">Select</option>
                                   <option value="PHMOB">Phone (Mobile)</option>
                                   <option value="PHHOM">Phone (Home)</option>
                                   <option value="PHWRK">Phone (Business/Work)</option>
               ...
               <div class="col-md-4 mt-3">
                    <div class="form-group">
                         ...
                         <div class="form-control-wrap">
                              <input type="text" class="form-control" name="e_emergency_family_name[${index}][]">
                         </div>
                    </div>
               </div>
               <div class="col-md-4 mt-3">
                    <div class="form-group">
                         ...
                         <div class="form-control-wrap">
                              <input type="text" class="form-control" name="e_emergency_comments[${index}][]">
                         </div>
                    </div>
               </div>
          </div>`);
...
function AdditionalEmergencyContact() {
     var intId = $(`.e_emergency_contact_form .row.count`).length + 1 || 1;
     var addFields = $(`<div class="row count mt-3" id="AdditionalEmergencyContact_parent_${intId}">
                              <div class="col-md-12 mt-3">
                                   <div class="educationalHeader">
                                        <p><strong class="emergency_contact_title">Additional emergency contact ${intId}</strong></p>
                              ...
                              <div class="col-md-6 mt-3">
                                   <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                             <input type="text" class="form-control" name="e_emergency_given_name[${intId}]">
                                        </div>
                                   </div>
                              </div>
                              <div class="col-md-6 mt-3">
                                   <div class="form-group">
                                        <label class="form-label">Family name</label>
                                        <div class="form-control-wrap">
                                             <input type="text" class="form-control" name="e_emergency_family_name[${intId}]">
                                        </div>
                                   </div>
                              </div>
                              <div class="col-md-12 mt-3">
                                   <div class="form-group">
                                        ...
                                        <select class="form-control" name="e_emergency_relationship[${intId}]">
                                             <option value="">Select</option>
                                             <option value="MUM">Mother</option>
                                             <option value="DAD">Father</option>
                                             <option value="GMO">Grandmother</option>
                                        ...
                                        <div class="row mt-3">
                                             ...
                                             <div class="col-md-4 mt-3">
                                                  <div class="form-group">
                                                       <label class="form-label">Phone number type</label>
                                                       <div class="form-control-wrap">
                                                            <select  class="form-control" name="e_emergency_phone_number_type[${intId}][]">  
                                                                 <option value="">Select</option>
                                                                 <option value="PHMOB">Phone (Mobile)</option>
                                                                 <option value="PHHOM">Phone (Home)</option>
                                                                 <option value="PHWRK">Phone (Business/Work)</option>
                                             ...
                                             <div class="col-md-4 mt-3">
                                                  <div class="form-group">
                                                       <label class="form-label">Comments</label>
                                                       <div class="form-control-wrap">
                                                            <input type="text" class="form-control" name="e_emergency_comments[${intId}][]">
                                                       </div>
                                                  </div>
                                             </div>
                                        </div>
...
function changeLanguage(index, value) {
     if(value == "select") {
          $(`select[name=speaking_${index}]`).prop("disabled", true);
          $(`select[name=reading_${index}]`).prop("disabled", true);
          $(`select[name=writing_${index}]`).prop("disabled", true);
     } else {
          $(`select[name=speaking_${index}]`).prop("disabled", false);
          $(`select[name=reading_${index}]`).prop("disabled", false);
          $(`select[name=writing_${index}]`).prop("disabled", false);
     }
}
...
function educationAddMore(e) {
     e.preventDefault();
     var count = $("#firthForm .fileCount").length;
               ...
               <div class="form-group">
                    ...
                    <div class="form-control-wrap flex">
                         <div class="custom-file">
                              <input type="file" class="custom-file-input" id="educationFile_${count}" name="educationFile_${count}" onchange="selectEducationFile(${count})" required>
...
function employmentRecordAddMore(e) {
     ...
     <div class="col-xxl-6 col-md-4 employmentRecordCount">
          <div class="form-group">
               ...
               <div class="form-control-wrap flex">
                    <div class="custom-file">
                         <input type="file" class="custom-file-input" id="employmentRecord_${count}" name="employmentRecord_${count}" onchange="selectEmploymentRecordFile(${count})" required>
...
function SupportingDocAddMore(e) {
     ...
     <div class="col-xxl-6 col-md-4 supportingDocCount">
          <div class="form-group">
               ...
               <div class="form-control-wrap flex">
                    <div class="custom-file">
                         <input type="file" accept=".doc,.docx,.pdf,.jpeg" class="custom-file-input" id="supportingDoc_${count}" name="supportingDoc_${count}" onchange="selectSupportingDocFile(${count})" required>
...
function eccreditationWorkAddMore(e) {
     ...
     <div class="col-xxl-6 col-md-4 eccreditationWorkCount">
          <div class="form-group">
               <div class="form-control-wrap flex">
                    <div class="custom-file">
                         <input type="file" accept=".doc,.docx,.pdf,.jpeg" class="custom-file-input" id="eccreditationWork_${count}" name="eccreditationWork_${count}" onchange="selectEccreditationWorkFile(${count})" required>
